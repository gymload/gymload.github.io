...
;
	($.$tukanable_gymload_title) = class $tukanable_gymload_title extends ($.$mol_view) {
		Title(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.title())]);
			return obj;
	...
	($mol_mem(($.$tukanable_gymload_title.prototype), "Title"));
	($mol_mem(($.$tukanable_gymload_title.prototype), "Extra"));
...
;
	($.$tukanable_gymload_builder_day) = class $tukanable_gymload_builder_day extends ($.$mol_view) {
		...
		Marker_hor(id){
			...
			(obj.labels) = () => ((this.week_labels(id)));
			return obj;
		}
		Chart(id){
		...
		day_title(){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_day_title"));
		}
		DayTitle(){
		...
		EmptyExercises(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.no_exercises())]);
			return obj;
		}
		row_exercise_title(id){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_row_exercise_title"));
		}
		...
		Exercise(id){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.row_exercise(id, next)));
			return obj;
		}
		Exercise_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.row_exercise_title(id)));
			(obj.Content) = () => ((this.Exercise(id)));
			return obj;
		}
		row_weight_type(id, next){
			if(next !== undefined) return next;
			return "custom";
		}
		row_weight_types(id){
		...
		WeightType(id){
			...
			(obj.Filter) = () => (null);
			(obj.value) = (next) => ((this.row_weight_type(id, next)));
			(obj.dictionary) = () => ((this.row_weight_types(id)));
			return obj;
		}
		WeightType_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_day_WeightType_labeler_title")));
		...
		Sets(id){
			const obj = new this.$.$tukanable_gymload_smallnumber();
			(obj.value) = (next) => ((this.row_sets(id, next)));
			return obj;
		}
		Sets_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_day_Sets_labeler_title")));
			(obj.Content) = () => ((this.Sets(id)));
			return obj;
		}
		row_reps(id, next){
			if(next !== undefined) return next;
		...
		Reps(id){
			const obj = new this.$.$tukanable_gymload_smallnumber();
			(obj.value) = (next) => ((this.row_reps(id, next)));
			return obj;
		}
		Reps_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_day_Reps_labeler_title")));
		...
		FinishWeight(id){
			...
			(obj.precision_change) = () => ((this.row_min_step(id)));
			(obj.value_min) = () => ((this.row_min_weight(id)));
			(obj.value) = (next) => ((this.row_finish_weight(id, next)));
			return obj;
		}
		FinishWeight_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_day_FinishWeight_labeler_title")));
			(obj.Content) = () => ((this.FinishWeight(id)));
			return obj;
		}
		min_step_labeler(id){
			return null;
		...
		Remove_close_icon(id){
			const obj = new this.$.$mol_icon_close();
			return obj;
		}
		RemoveButton(id){
			const obj = new this.$.$mol_button_major();
			(obj.click) = (next) => ((this.row_remove(id, next)));
			(obj.sub) = () => ([(this.Remove_close_icon(id))]);
			return obj;
		}
		row_content(id){
			return [
		...
		row_view(id){
			return [(this.InputRow(id))];
		}
		Row(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.row_view(id)));
			return obj;
		}
		rows(){
			return [(this.Row("0"))];
		...
		Rows(){
			...
			(obj.Empty) = (id) => ((this.EmptyExercises()));
			(obj.rows) = () => ((this.rows()));
			return obj;
		}
		add_exercise(next){
		...
		weight_types(){
			return {
				...
				"dumbbell": (this.$.$mol_locale.text("$tukanable_gymload_builder_day_weight_types_dumbbell")), 
				"barbell": (this.$.$mol_locale.text("$tukanable_gymload_builder_day_weight_types_barbell"))
			};
		}
		MinStepLabeler(id){
			const obj = new this.$.$mol_labeler();
	...
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "Chart"));
	($mol_mem(($.$tukanable_gymload_builder_day.prototype), "DayTitle"));
	($mol_mem(($.$tukanable_gymload_builder_day.prototype), "EmptyExercises"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "row_exercise"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "Exercise"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "Exercise_labeler"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "row_weight_type"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "WeightType"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "WeightType_labeler"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "row_sets"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "Sets"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "Sets_labeler"));
	...
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "row_remove"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "Remove_close_icon"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "RemoveButton"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "InputRow"));
	($mol_mem_key(($.$tukanable_gymload_builder_day.prototype), "Row"));
	($mol_mem(($.$tukanable_gymload_builder_day.prototype), "Rows"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $tukanable_gymload_builder_day extends $.$tukanable_gymload_builder_day {
            build_key(s) {
            ...
            row_weight_type(id, next) {
                let v = this.change_field('weight_type', id, next) || empty_item.weight_type;
        ...
        __decorate([
            $mol_mem_key
        ], $tukanable_gymload_builder_day.prototype, "plan", null);
        __decorate([
            $mol_mem
...
;
	($.$tukanable_gymload_builder_weights) = class $tukanable_gymload_builder_weights extends ($.$mol_view) {
		row_title(id){
			return "";
		}
		row_value(id, next){
		...
		Value(id){
			const obj = new this.$.$tukanable_gymload_smallnumber();
			(obj.precision) = () => (0.1);
			(obj.value) = (next) => ((this.row_value(id, next)));
			return obj;
		}
		Labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.row_title(id)));
			(obj.Content) = () => ((this.Value(id)));
			return obj;
		}
		row_remove(id, next){
			if(next !== undefined) return next;
		...
		Item(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Labeler(id)), (this.RemoveButton(id))]);
			return obj;
		}
		AddButton(){
			const obj = new this.$.$mol_button_major();
			(obj.click) = (next) => ((this.add()));
	...
	($mol_mem_key(($.$tukanable_gymload_builder_weights.prototype), "row_value"));
	($mol_mem_key(($.$tukanable_gymload_builder_weights.prototype), "Value"));
	($mol_mem_key(($.$tukanable_gymload_builder_weights.prototype), "Labeler"));
	($mol_mem_key(($.$tukanable_gymload_builder_weights.prototype), "row_remove"));
	($mol_mem_key(($.$tukanable_gymload_builder_weights.prototype), "Remove_close_icon"));
	($mol_mem_key(($.$tukanable_gymload_builder_weights.prototype), "RemoveButton"));
	($mol_mem(($.$tukanable_gymload_builder_weights.prototype), "add"));
	($mol_mem(($.$tukanable_gymload_builder_weights.prototype), "Add_icon"));
	($mol_mem(($.$tukanable_gymload_builder_weights.prototype), "enabled"));
	($mol_mem(($.$tukanable_gymload_builder_weights.prototype), "Enabled"));
	($mol_mem(($.$tukanable_gymload_builder_weights.prototype), "Items"));
	($mol_mem_key(($.$tukanable_gymload_builder_weights.prototype), "Item"));
	($mol_mem(($.$tukanable_gymload_builder_weights.prototype), "AddButton"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $tukanable_gymload_builder_weights extends $.$tukanable_gymload_builder_weights {
            build_key(s) {
        ...
        __decorate([
            $mol_mem
        ], $tukanable_gymload_builder_weights.prototype, "values", null);
        __decorate([
            $mol_mem
        ], $tukanable_gymload_builder_weights.prototype, "new_id", null);
        $$.$tukanable_gymload_builder_weights = $tukanable_gymload_builder_weights;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        const { rem } = $mol_style_unit;
        $mol_style_define($tukanable_gymload_builder_weights, {
            flexDirection: 'column',
            Items: {
                flexDirection: 'row',
                flexWrap: 'wrap',
...
;
	($.$tukanable_gymload_builder_day_results_set) = class $tukanable_gymload_builder_day_results_set extends ($.$mol_view) {
		past_week_results(){
			return "";
		}
		week_plan_weight(){
		...
		CurrentWeekWeight_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.week_plan_weight()));
		...
		CurrentWeekReps(){
			const obj = new this.$.$tukanable_gymload_smallnumber();
			(obj.value) = (next) => ((this.week_reps(next)));
			return obj;
		}
		...
		done_plan_label(){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_results_set_done_plan_label"));
		}
		PlanLabel(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.done_plan_label())]);
			return obj;
		}
		done_week_click(next){
			if(next !== undefined) return next;
			return null;
		}
		DoneButton(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_day_results_set_DoneButton_title")));
			(obj.click) = (next) => ((this.done_week_click(next)));
			return obj;
		}
		future_week_results(){
			return "";
		...
		set_idx_label(){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_results_set_set_idx_label"));
		}
		SetIndex(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.set_idx_label())]);
			return obj;
		}
		storage_key(){
			return "setresult";
		...
		PastWeekView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.past_week_results())]);
			return obj;
		}
		CurrentWeekView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.CurrentWeekWeight_labeler()), (this.CurrentWeekReps_labeler())]);
			return obj;
		}
		DoneWeekView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.PlanLabel()), (this.DoneButton())]);
			return obj;
		}
		FutureWeekView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.future_week_results())]);
			return obj;
		}
		sub(){
	...
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "week_weight"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "CurrentWeekWeight"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "CurrentWeekWeight_labeler"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "week_reps"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "CurrentWeekReps"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "CurrentWeekReps_labeler"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "PlanLabel"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "done_week_click"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "DoneButton"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "SetIndex"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "PastWeekView"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "CurrentWeekView"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "DoneWeekView"));
	($mol_mem(($.$tukanable_gymload_builder_day_results_set.prototype), "FutureWeekView"));
    ...
    (function ($$) {
        class $tukanable_gymload_builder_day_results_set extends $.$tukanable_gymload_builder_day_results_set {
            ...
            past_week_results() {
                ...
                const w = Math.max(this.week_weight_value(this.week_idx() - 1), this.plan()[this.week_idx() - 1] || -1);
...
;
	($.$tukanable_gymload_builder_day_results) = class $tukanable_gymload_builder_day_results extends ($.$tukanable_gymload_builder_day) {
		set_idx(id){
			return 0;
		}
		current_week_number(){
		...
		week_tab_title_short(id){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_results_week_tab_title_short"));
		}
		week_tab_title(id){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_results_week_tab_title"));
		}
		WeekTitle(id){
			const obj = new this.$.$tukanable_gymload_title();
			(obj.title) = () => ((this.week_tab_title(id)));
			return obj;
		}
		day_title(){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_results_day_title"));
		}
		DayTitle(){
			const obj = new this.$.$tukanable_gymload_title();
			(obj.title) = () => ((this.day_title()));
		...
		current_week(next){
			return (this.Weeks().current(next));
		}
		week_items(){
			return [];
		}
		...
		ExcerciseTitle(id){
			const obj = new this.$.$tukanable_gymload_title();
			(obj.title) = () => ((this.row_exercise_extra(id)));
			return obj;
		}
		set_rows(id){
			return [];
		...
		SetRows(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.set_rows(id)));
			return obj;
		}
		Row(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.ExcerciseTitle(id)), (this.SetRows(id))]);
			return obj;
		}
		rows(){
			return [(this.Row("0"))];
		...
		SetResult(id){
			const obj = new this.$.$tukanable_gymload_builder_day_results_set();
			(obj.set_idx) = () => ((this.set_idx(id)));
			(obj.week_idx) = () => ((this.current_week_number()));
			(obj.week_count) = () => ((this.week_count()));
			(obj.excercise_idx) = () => ((this.excercise_idx(id)));
		...
		WeekTab(id){
			const obj = new this.$.$mol_view();
			(obj.title) = () => ((this.week_tab_title_short(id)));
			(obj.sub) = () => ([(this.WeekTitle(id))]);
			return obj;
		}
		sub(){
			return [
	...
	($mol_mem_key(($.$tukanable_gymload_builder_day_results.prototype), "row_sets"));
	($mol_mem_key(($.$tukanable_gymload_builder_day_results.prototype), "WeekTitle"));
	($mol_mem(($.$tukanable_gymload_builder_day_results.prototype), "DayTitle"));
	($mol_mem(($.$tukanable_gymload_builder_day_results.prototype), "Weeks"));
	($mol_mem_key(($.$tukanable_gymload_builder_day_results.prototype), "ExcerciseTitle"));
	($mol_mem_key(($.$tukanable_gymload_builder_day_results.prototype), "SetRows"));
	($mol_mem_key(($.$tukanable_gymload_builder_day_results.prototype), "Row"));
	($mol_mem(($.$tukanable_gymload_builder_day_results.prototype), "Rows"));
	($mol_mem_key(($.$tukanable_gymload_builder_day_results.prototype), "SetResult"));
	($mol_mem_key(($.$tukanable_gymload_builder_day_results.prototype), "WeekTab"));
...
;
	($.$tukanable_gymload_builder) = class $tukanable_gymload_builder extends ($.$mol_view) {
		day_storage_key(id){
			return "";
		}
		day_title(id){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_day_title"));
		}
		day_index(id){
			return 0;
		}
		...
		WeekCount(){
			...
			(obj.value) = (next) => ((this.week_count(next)));
			return obj;
		}
		WeekCount_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_WeekCount_labeler_title")));
			(obj.Content) = () => ((this.WeekCount()));
			return obj;
		}
		day_count(next){
			if(next !== undefined) return next;
		...
		DayCount(){
			const obj = new this.$.$mol_number();
			(obj.value) = (next) => ((this.day_count(next)));
			return obj;
		}
		DayCount_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_DayCount_labeler_title")));
			(obj.Content) = () => ((this.DayCount()));
			return obj;
		}
		show_charts(next){
			if(next !== undefined) return next;
		...
		ShowCharts_wrapper(){
			...
			(obj.checked) = (next) => ((this.show_charts(next)));
			return obj;
		}
		ShowCharts_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_ShowCharts_labeler_title")));
		...
		dumbbell_values(){
			return (this.DumbbellWeighs().values());
		}
		DumbbellWeighs(){
			const obj = new this.$.$tukanable_gymload_builder_weights();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_DumbbellWeighs_title")));
			return obj;
		}
		barbell_values(){
			return (this.BarbellWeights().values());
		}
		BarbellWeights(){
			const obj = new this.$.$tukanable_gymload_builder_weights();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_BarbellWeights_title")));
			(obj.storage_key) = () => ("barbell_weights");
			return obj;
		}
		weight_plate_values(){
			return (this.WeightPlates().values());
		}
		WeightPlates(){
			const obj = new this.$.$tukanable_gymload_builder_weights();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_WeightPlates_title")));
			(obj.storage_key) = () => ("weight_plates");
			return obj;
		}
		week_items(){
			return [];
		...
		TopDesk(){
			const obj = new this.$.$mol_deck();
			(obj.current) = (next) => ((this.top_desk_current(next)));
			(obj.items) = () => ((this.top_desk_items()));
			return obj;
		}
		storage_key(){
			return "gymload_builder";
		}
		DaySettings(id){
			const obj = new this.$.$tukanable_gymload_builder_day();
			(obj.storage_key) = () => ((this.day_storage_key(id)));
			(obj.title) = () => ((this.day_title(id)));
			(obj.day_index) = () => ((this.day_index(id)));
		...
		DayResults(id){
			const obj = new this.$.$tukanable_gymload_builder_day_results();
			(obj.storage_key) = () => ((this.day_storage_key(id)));
			(obj.title) = () => ((this.day_title(id)));
			(obj.day_index) = () => ((this.day_index(id)));
			(obj.week_count) = () => ((this.week_count()));
		...
		Stats(){
			const obj = new this.$.$tukanable_gymload_builder_stats();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_Stats_title")));
		...
		Settings(){
			const obj = new this.$.$mol_view();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_Settings_title")));
			(obj.sub) = () => ([
				(this.Header()), 
				(this.DumbbellWeighs()), 
				(this.BarbellWeights()), 
	...
	($mol_mem(($.$tukanable_gymload_builder.prototype), "week_count"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "WeekCount"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "WeekCount_labeler"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "day_count"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "DayCount"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "DayCount_labeler"));
	...
	($mol_mem(($.$tukanable_gymload_builder.prototype), "WeightPlates"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "Weeks"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "top_desk_current"));
	($mol_mem(($.$tukanable_gymload_builder.prototype), "TopDesk"));
...
;
	($.$tukanable_gymload) = class $tukanable_gymload extends ($.$mol_page) {
		LogoButton(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"view": "program"});
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_LogoButton_title")));
			return obj;
		}
		Theme(){
		...
		NewTitle(){
			const obj = new this.$.$tukanable_gymload_title();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_NewTitle_title")));
			return obj;
		}
		new_name_bid(){
			return "";
		...
		NewName_field(){
			...
			(obj.name) = () => ((this.$.$mol_locale.text("$tukanable_gymload_NewName_field_name")));
			(obj.bid) = () => ((this.new_name_bid()));
			(obj.Content) = () => ((this.NewName_control()));
			return obj;
		}
		add_program(next){
			if(next !== undefined) return next;
		...
		add_allowed(){
			return (this.NewForm().submit_allowed());
		}
		NewSubmit(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_NewSubmit_title")));
			(obj.click) = (next) => ((this.add_program(next)));
		...
		NewForm(){
			...
			(obj.body) = () => ([(this.NewName_field())]);
			(obj.submit) = (next) => ((this.add_program(next)));
			(obj.buttons) = () => ([(this.NewSubmit()), (this.NewResult())]);
			return obj;
		}
		EditTitle(){
			const obj = new this.$.$tukanable_gymload_title();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_EditTitle_title")));
			return obj;
		}
		edit_name_bid(){
			return "";
		...
		EditName_control(){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.edit_name(next)));
			return obj;
		}
		EditName_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ((this.$.$mol_locale.text("$tukanable_gymload_EditName_field_name")));
			(obj.bid) = () => ((this.edit_name_bid()));
			(obj.Content) = () => ((this.EditName_control()));
			return obj;
		}
		edit_program(next){
			if(next !== undefined) return next;
		...
		EditSubmit(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_EditSubmit_title")));
			(obj.click) = (next) => ((this.edit_program(next)));
			(obj.enabled) = () => ((this.edit_allowed()));
			return obj;
		}
		EditResult(){
			const obj = new this.$.$mol_status();
		...
		delete_link_text(){
			return (this.$.$mol_locale.text("$tukanable_gymload_delete_link_text"));
		}
		DeleteLink(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"view": "delete_program"});
			(obj.sub) = () => ([(this.DeleteIcon()), (this.delete_link_text())]);
			return obj;
		}
		EditForm(){
			const obj = new this.$.$mol_form();
			(obj.body) = () => ([(this.EditName_field())]);
			(obj.submit) = (next) => ((this.edit_program(next)));
			(obj.buttons) = () => ([
				(this.EditSubmit()), 
				(this.EditResult()), 
				(this.Space()), 
		...
		DeleteTitle(){
			const obj = new this.$.$tukanable_gymload_title();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_DeleteTitle_title")));
			return obj;
		}
		delete_program(next){
			if(next !== undefined) return next;
		...
		DeleteConfirmButton(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_DeleteConfirmButton_title")));
			(obj.click) = (next) => ((this.delete_program(next)));
			return obj;
		}
		cancel_delete_program(next){
			if(next !== undefined) return next;
			return null;
		}
		DeleteCancelButton(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_DeleteCancelButton_title")));
			(obj.click) = (next) => ((this.cancel_delete_program(next)));
			return obj;
		}
		DeleteActions(){
			const obj = new this.$.$mol_view();
		...
		required_label(){
			return (this.$.$mol_locale.text("$tukanable_gymload_required_label"));
		}
		default_program_name(){
			return (this.$.$mol_locale.text("$tukanable_gymload_default_program_name"));
		}
		plugins(){
			return [(this.Theme())];
		}
		...
		ListPrograms(){
			const obj = new this.$.$mol_select();
			(obj.dictionary) = () => ((this.programs()));
			(obj.value) = (next) => ((this.current_program_string(next)));
			return obj;
		}
		HelpPage(){
			const obj = new this.$.$tukanable_gymload_help();
			return obj;
		}
		EditProgram(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"view": "edit_program"});
			(obj.sub) = () => ([(this.EditProgram_icon())]);
			return obj;
		}
		AddProgram(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"view": "add_program"});
			(obj.sub) = () => ([(this.AddProgram_icon())]);
			return obj;
		}
		Builder(){
			const obj = new this.$.$tukanable_gymload_builder();
			(obj.storage_key) = () => ((this.builder_storage_key()));
			return obj;
		}
		NewView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.NewTitle()), (this.NewForm())]);
			return obj;
		}
		EditView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.EditTitle()), (this.EditForm())]);
			return obj;
		}
		DeleteView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.DeleteTitle()), (this.DeleteActions())]);
			return obj;
		}
	};
	($mol_mem(($.$tukanable_gymload.prototype), "LogoButton"));
	($mol_mem(($.$tukanable_gymload.prototype), "Theme"));
	($mol_mem(($.$tukanable_gymload.prototype), "Help_icon"));
	($mol_mem(($.$tukanable_gymload.prototype), "Help"));
	($mol_mem(($.$tukanable_gymload.prototype), "List_of_languages"));
	($mol_mem(($.$tukanable_gymload.prototype), "Lighter"));
	($mol_mem(($.$tukanable_gymload.prototype), "current_program_string"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditProgram_icon"));
	($mol_mem(($.$tukanable_gymload.prototype), "AddProgram_icon"));
	($mol_mem(($.$tukanable_gymload.prototype), "NewTitle"));
	($mol_mem(($.$tukanable_gymload.prototype), "new_name"));
	($mol_mem(($.$tukanable_gymload.prototype), "NewName_control"));
	($mol_mem(($.$tukanable_gymload.prototype), "NewName_field"));
	($mol_mem(($.$tukanable_gymload.prototype), "add_program"));
	($mol_mem(($.$tukanable_gymload.prototype), "NewSubmit"));
	($mol_mem(($.$tukanable_gymload.prototype), "result"));
	($mol_mem(($.$tukanable_gymload.prototype), "NewResult"));
	($mol_mem(($.$tukanable_gymload.prototype), "NewForm"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditTitle"));
	($mol_mem(($.$tukanable_gymload.prototype), "edit_name"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditName_control"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditName_field"));
	($mol_mem(($.$tukanable_gymload.prototype), "edit_program"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditSubmit"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditResult"));
	($mol_mem(($.$tukanable_gymload.prototype), "Space"));
	($mol_mem(($.$tukanable_gymload.prototype), "DeleteIcon"));
	($mol_mem(($.$tukanable_gymload.prototype), "DeleteLink"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditForm"));
	($mol_mem(($.$tukanable_gymload.prototype), "DeleteTitle"));
	($mol_mem(($.$tukanable_gymload.prototype), "delete_program"));
	($mol_mem(($.$tukanable_gymload.prototype), "DeleteConfirmButton"));
	($mol_mem(($.$tukanable_gymload.prototype), "cancel_delete_program"));
	($mol_mem(($.$tukanable_gymload.prototype), "DeleteCancelButton"));
	($mol_mem(($.$tukanable_gymload.prototype), "DeleteActions"));
	($mol_mem(($.$tukanable_gymload.prototype), "ListPrograms"));
	($mol_mem(($.$tukanable_gymload.prototype), "HelpPage"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditProgram"));
	($mol_mem(($.$tukanable_gymload.prototype), "AddProgram"));
	($mol_mem(($.$tukanable_gymload.prototype), "Builder"));
	($mol_mem(($.$tukanable_gymload.prototype), "NewView"));
	($mol_mem(($.$tukanable_gymload.prototype), "EditView"));
	($mol_mem(($.$tukanable_gymload.prototype), "DeleteView"));
	($.$tukanable_gymload_help) = class $tukanable_gymload_help extends ($.$mol_view) {
		content(){
			return "Help not available yet.";
		}
		Text(){
			const obj = new this.$.$mol_text();
	...
	($mol_mem(($.$tukanable_gymload_help.prototype), "Text"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $tukanable_gymload extends $.$tukanable_gymload {
            ...
            current_view(next) {
                return this.$.$mol_state_arg.value('view', next) || 'program';
            }
            tools() {
            ...
            cancel_delete_program() {
                this.current_view('program');
            }
        }
        __decorate([
            $mol_mem
        ], $tukanable_gymload.prototype, "edit_name", null);
        __decorate([
            $mol_mem
        ], $tukanable_gymload.prototype, "new_program_id", null);
        ...
        __decorate([
            $mol_mem
        ], $tukanable_gymload_help.prototype, "content", null);
        $$.$tukanable_gymload_help = $tukanable_gymload_help;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($tukanable_gymload, {
            NewView: {
                flexDirection: 'column',
            },
            EditView: {
...
;
	($.$tukanable_gymload_builder_export_print) = class $tukanable_gymload_builder_export_print extends ($.$mol_view) {
		...
		PrintButton(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$tukanable_gymload_builder_export_print_PrintButton_title")));
	...
	($.$tukanable_gymload_builder_export_print_day) = class $tukanable_gymload_builder_export_print_day extends ($.$mol_view) {
		excercise_title_extra_title(id){
			return "";
		}
		excercise_title_extra_extra(id){
			return "";
		}
		Title(id){
			const obj = new this.$.$tukanable_gymload_title();
			(obj.title) = () => ((this.excercise_title_extra_title(id)));
			(obj.extra) = () => ((this.excercise_title_extra_extra(id)));
			return obj;
		}
		excercise_sets(id){
			return 3;
		...
		day_name(){
			return (this.$.$mol_locale.text("$tukanable_gymload_builder_export_print_day_day_name"));
		}
		DayName(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.day_name())]);
			return obj;
		}
		model(){
			const obj = new this.$.$tukanable_gymload_builder_day();
	...
	($mol_mem(($.$tukanable_gymload_builder_export_print_day.prototype), "DayName"));
	...
	($.$tukanable_gymload_builder_export_print_table) = class $tukanable_gymload_builder_export_print_table extends ($.$mol_view) {
		...
		ResultCellEnd(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.result_end(id))]);
			return obj;
		}
		ResultCellContent(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.ResultCellBegin(id)), (this.ResultCellEnd(id))]);
			return obj;
		}
		columns(id){
			return [];
		...
		SetCell(id){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("td");
			(obj.sub) = () => ([(this.set_idx(id))]);
			return obj;
		}
		ResultCell(id){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("td");
			(obj.sub) = () => ([(this.ResultCellContent(id))]);
			return obj;
		}
		SetRow(id){
			const obj = new this.$.$mol_view();
	...
	($mol_mem_key(($.$tukanable_gymload_builder_export_print_table.prototype), "ResultCellBegin"));
	($mol_mem_key(($.$tukanable_gymload_builder_export_print_table.prototype), "ResultCellEnd"));
	($mol_mem_key(($.$tukanable_gymload_builder_export_print_table.prototype), "ResultCellContent"));
