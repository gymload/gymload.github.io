...
declare namespace $ {
	...
	export class $gymload_smallnumber extends $mol_number {
	}
...
declare namespace $ {
	...
	type $gymload_smallnumber__precision_gymload_builder_weights_1 = $mol_type_enforce<
		number
		,
		ReturnType< $gymload_smallnumber['precision'] >
	>
	type $gymload_smallnumber__value_gymload_builder_weights_2 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['row_value'] >
		,
		ReturnType< $gymload_smallnumber['value'] >
	>
	type $mol_labeler__title_gymload_builder_weights_3 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['row_title'] >
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_weights_4 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['Value'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_button_major__title_gymload_builder_weights_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_gymload_builder_weights_6 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['row_remove'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_check_expand__title_gymload_builder_weights_7 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['title'] >
		,
		ReturnType< $mol_check_expand['title'] >
	>
	type $mol_check_expand__checked_gymload_builder_weights_8 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['enabled'] >
		,
		ReturnType< $mol_check_expand['checked'] >
	>
	type $mol_view__sub_gymload_builder_weights_9 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['items'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_gymload_builder_weights_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_major__title_gymload_builder_weights_11 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_gymload_builder_weights_12 = $mol_type_enforce<
		ReturnType< $gymload_builder_weights['add'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	export class $gymload_builder_weights extends $mol_view {
		row_title( id: any): string
		row_value( id: any, next?: number ): number
		Value( id: any): $gymload_smallnumber
...
declare namespace $ {
	...
	type $gymload_smallnumber__precision_gymload_builder_day_1 = $mol_type_enforce<
		number
		,
		ReturnType< $gymload_smallnumber['precision'] >
	>
	type $gymload_smallnumber__value_gymload_builder_day_2 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_min_step'] >
		,
		ReturnType< $gymload_smallnumber['value'] >
	>
	type $mol_view__sub_gymload_builder_day_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_plot_bar__series_y_gymload_builder_day_4 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['plan'] >
		,
		ReturnType< $mol_plot_bar['series_y'] >
	>
	type $mol_plot_mark_hor__title_gymload_builder_day_5 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['marker_hor_title'] >
		,
		ReturnType< $mol_plot_mark_hor['title'] >
	>
	type $mol_plot_mark_hor__labels_gymload_builder_day_6 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['week_labels'] >
		,
		ReturnType< $mol_plot_mark_hor['labels'] >
	>
	type $mol_chart__graphs_gymload_builder_day_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_chart['graphs'] >
	>
	type $mol_view__sub_gymload_builder_day_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_string__value_gymload_builder_day_9 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_exercise'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_labeler__title_gymload_builder_day_10 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_exercise_title'] >
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_day_11 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['Exercise'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_select__Filter_gymload_builder_day_12 = $mol_type_enforce<
		any
		,
		ReturnType< $mol_select['Filter'] >
	>
	type $mol_select__value_gymload_builder_day_13 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_weight_type'] >
		,
		ReturnType< $mol_select['value'] >
	>
	type $mol_select__dictionary_gymload_builder_day_14 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_weight_types'] >
		,
		ReturnType< $mol_select['dictionary'] >
	>
	type $mol_labeler__title_gymload_builder_day_15 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_day_16 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['WeightType'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $gymload_smallnumber__value_gymload_builder_day_17 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_sets'] >
		,
		ReturnType< $gymload_smallnumber['value'] >
	>
	type $mol_labeler__title_gymload_builder_day_18 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_day_19 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['Sets'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $gymload_smallnumber__value_gymload_builder_day_20 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_reps'] >
		,
		ReturnType< $gymload_smallnumber['value'] >
	>
	type $mol_labeler__title_gymload_builder_day_21 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_day_22 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['Reps'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $gymload_smallnumber__precision_view_gymload_builder_day_23 = $mol_type_enforce<
		number
		,
		ReturnType< $gymload_smallnumber['precision_view'] >
	>
	type $gymload_smallnumber__precision_change_gymload_builder_day_24 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_min_step'] >
		,
		ReturnType< $gymload_smallnumber['precision_change'] >
	>
	type $gymload_smallnumber__value_min_gymload_builder_day_25 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_min_weight'] >
		,
		ReturnType< $gymload_smallnumber['value_min'] >
	>
	type $gymload_smallnumber__value_gymload_builder_day_26 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_begin_weight'] >
		,
		ReturnType< $gymload_smallnumber['value'] >
	>
	type $mol_labeler__title_gymload_builder_day_27 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_day_28 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['BeginWeight'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $gymload_smallnumber__precision_view_gymload_builder_day_29 = $mol_type_enforce<
		number
		,
		ReturnType< $gymload_smallnumber['precision_view'] >
	>
	type $gymload_smallnumber__precision_change_gymload_builder_day_30 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_min_step'] >
		,
		ReturnType< $gymload_smallnumber['precision_change'] >
	>
	type $gymload_smallnumber__value_min_gymload_builder_day_31 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_min_weight'] >
		,
		ReturnType< $gymload_smallnumber['value_min'] >
	>
	type $gymload_smallnumber__value_gymload_builder_day_32 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_finish_weight'] >
		,
		ReturnType< $gymload_smallnumber['value'] >
	>
	type $mol_labeler__title_gymload_builder_day_33 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_day_34 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['FinishWeight'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	type $mol_button_major__title_gymload_builder_day_35 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_gymload_builder_day_36 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_remove'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_row__sub_gymload_builder_day_37 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['row_content'] >
		,
		ReturnType< $mol_row['sub'] >
	>
	type $mol_view__sub_gymload_builder_day_38 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__item_width_min_gymload_builder_day_39 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_list['item_width_min'] >
	>
	type $mol_list__item_height_min_gymload_builder_day_40 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_list['item_height_min'] >
	>
	type $mol_list__rows_gymload_builder_day_41 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_button_major__title_gymload_builder_day_42 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_gymload_builder_day_43 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['add_exercise'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_labeler__title_gymload_builder_day_44 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_day_45 = $mol_type_enforce<
		ReturnType< $gymload_builder_day['MinStep'] >
		,
		ReturnType< $mol_labeler['Content'] >
	>
	export class $gymload_builder_day extends $mol_view {
		row_min_step( id: any, next?: number ): number
		MinStep( id: any): $gymload_smallnumber
		day_title( ): string
		DayTitle( ): $mol_view
...
declare namespace $ {
	...
	type $gymload_smallnumber__value_gymload_builder_day_results_set_1 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results_set['week_weight'] >
		,
		ReturnType< $gymload_smallnumber['value'] >
	>
	...
	type $mol_view__sub_gymload_builder_day_results_set_9 = $mol_type_enforce<
		...
		ReturnType< $mol_view['sub'] >
	>
	export class $gymload_builder_day_results_set extends $mol_view {
...
declare namespace $.$$ {
    class $gymload_builder_day_results_set extends $.$gymload_builder_day_results_set {
        sub(): $mol_view[];
...
declare namespace $ {
	...
	type $mol_view__sub_gymload_builder_day_results_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type __gymload_builder_day_results_2 = $mol_type_enforce<
		Parameters< $gymload_builder_day_results['current_week'] >[0]
		,
		Parameters< ReturnType< $gymload_builder_day_results['Weeks'] >['current'] >[0]
	>
	type $mol_deck__items_gymload_builder_day_results_3 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['week_items'] >
		,
		ReturnType< $mol_deck['items'] >
	>
	type $mol_view__sub_gymload_builder_day_results_4 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['set_rows'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_gymload_builder_day_results_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__item_width_min_gymload_builder_day_results_6 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_list['item_width_min'] >
	>
	type $mol_list__item_height_min_gymload_builder_day_results_7 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_list['item_height_min'] >
	>
	type $mol_list__rows_gymload_builder_day_results_8 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $gymload_builder_day_results_set__set_idx_gymload_builder_day_results_9 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['set_idx'] >
		,
		ReturnType< $gymload_builder_day_results_set['set_idx'] >
	>
	type $gymload_builder_day_results_set__week_idx_gymload_builder_day_results_10 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['current_week_number'] >
		,
		ReturnType< $gymload_builder_day_results_set['week_idx'] >
	>
	type $gymload_builder_day_results_set__week_count_gymload_builder_day_results_11 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['week_count'] >
		,
		ReturnType< $gymload_builder_day_results_set['week_count'] >
	>
	type $gymload_builder_day_results_set__excercise_idx_gymload_builder_day_results_12 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['excercise_idx'] >
		,
		ReturnType< $gymload_builder_day_results_set['excercise_idx'] >
	>
	type $gymload_builder_day_results_set__reps_gymload_builder_day_results_13 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['row_sets'] >
		,
		ReturnType< $gymload_builder_day_results_set['reps'] >
	>
	type $gymload_builder_day_results_set__plan_gymload_builder_day_results_14 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['excercise_plan'] >
		,
		ReturnType< $gymload_builder_day_results_set['plan'] >
	>
	type $gymload_builder_day_results_set__storage_key_gymload_builder_day_results_15 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['storage_key'] >
		,
		ReturnType< $gymload_builder_day_results_set['storage_key'] >
	>
	type $mol_view__title_gymload_builder_day_results_16 = $mol_type_enforce<
		ReturnType< $gymload_builder_day_results['week_tab_title'] >
		,
		ReturnType< $mol_view['title'] >
	>
	type $mol_view__sub_gymload_builder_day_results_17 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $gymload_builder_day_results extends $gymload_builder_day {
		...
		day_title( ): string
		DayTitle( ): $mol_view
		current_week( next?: ReturnType< ReturnType< $gymload_builder_day_results['Weeks'] >['current'] > ): ReturnType< ReturnType< $gymload_builder_day_results['Weeks'] >['current'] >
		...
		Rows( ): $mol_list
		week_count( ): number
		SetResult( id: any): $gymload_builder_day_results_set
...
declare namespace $.$$ {
    class $gymload_builder_day_results extends $.$gymload_builder_day_results {
        rows(): $mol_view[];
        set_rows(id: any): $.$gymload_builder_day_results_set[];
        set_idx(id: any): any;
        excercise_idx(id: any): number;
        excercise_plan(id: any): readonly (number)[];
        week_items(): $mol_view[];
...
declare namespace $ {
	...
	type $mol_number__value_gymload_builder_1 = $mol_type_enforce<
		ReturnType< $gymload_builder['week_count'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_labeler__title_gymload_builder_2 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__Content_gymload_builder_3 = $mol_type_enforce<
	...
	type $mol_labeler__Content_gymload_builder_6 = $mol_type_enforce<
		...
		ReturnType< $mol_labeler['Content'] >
	>
	type $gymload_builder_weights__title_gymload_builder_7 = $mol_type_enforce<
		string
		,
		ReturnType< $gymload_builder_weights['title'] >
	>
	type $gymload_builder_weights__title_gymload_builder_8 = $mol_type_enforce<
		string
		,
		ReturnType< $gymload_builder_weights['title'] >
	>
	type $gymload_builder_weights__storage_key_gymload_builder_9 = $mol_type_enforce<
		string
		,
	...
	type $gymload_builder_weights__storage_key_gymload_builder_11 = $mol_type_enforce<
		...
		ReturnType< $gymload_builder_weights['storage_key'] >
	>
	type $mol_deck__items_gymload_builder_12 = $mol_type_enforce<
		ReturnType< $gymload_builder['week_items'] >
		,
		ReturnType< $mol_deck['items'] >
	>
	type $mol_deck__items_gymload_builder_13 = $mol_type_enforce<
		ReturnType< $gymload_builder['top_desk_items'] >
		,
		ReturnType< $mol_deck['items'] >
	>
	type $gymload_builder_day__storage_key_gymload_builder_14 = $mol_type_enforce<
		ReturnType< $gymload_builder['day_storage_key'] >
		,
		ReturnType< $gymload_builder_day['storage_key'] >
	>
	type $gymload_builder_day__title_gymload_builder_15 = $mol_type_enforce<
		ReturnType< $gymload_builder['day_title'] >
		,
		ReturnType< $gymload_builder_day['title'] >
	>
	type $gymload_builder_day__day_index_gymload_builder_16 = $mol_type_enforce<
		ReturnType< $gymload_builder['day_index'] >
		,
		ReturnType< $gymload_builder_day['day_index'] >
	>
	type $gymload_builder_day__dumbbell_values_gymload_builder_17 = $mol_type_enforce<
		ReturnType< $gymload_builder['dumbbell_values'] >
		,
		ReturnType< $gymload_builder_day['dumbbell_values'] >
	>
	type $gymload_builder_day__week_count_gymload_builder_18 = $mol_type_enforce<
		ReturnType< $gymload_builder['week_count'] >
		,
		ReturnType< $gymload_builder_day['week_count'] >
	>
	type $gymload_builder_day__weight_plate_values_gymload_builder_19 = $mol_type_enforce<
		ReturnType< $gymload_builder['weight_plate_values'] >
		,
		ReturnType< $gymload_builder_day['weight_plate_values'] >
	>
	type $gymload_builder_day__barbell_values_gymload_builder_20 = $mol_type_enforce<
		ReturnType< $gymload_builder['barbell_values'] >
		,
		ReturnType< $gymload_builder_day['barbell_values'] >
	>
	type $gymload_builder_day_results__storage_key_gymload_builder_21 = $mol_type_enforce<
		ReturnType< $gymload_builder['day_storage_key'] >
		,
		ReturnType< $gymload_builder_day_results['storage_key'] >
	>
	type $gymload_builder_day_results__title_gymload_builder_22 = $mol_type_enforce<
		ReturnType< $gymload_builder['day_title'] >
		,
		ReturnType< $gymload_builder_day_results['title'] >
	>
	type $gymload_builder_day_results__day_index_gymload_builder_23 = $mol_type_enforce<
		ReturnType< $gymload_builder['day_index'] >
		,
		ReturnType< $gymload_builder_day_results['day_index'] >
	>
	type $gymload_builder_day_results__week_count_gymload_builder_24 = $mol_type_enforce<
		ReturnType< $gymload_builder['week_count'] >
		,
		ReturnType< $gymload_builder_day_results['week_count'] >
	>
	type $gymload_builder_day_results__dumbbell_values_gymload_builder_25 = $mol_type_enforce<
		ReturnType< $gymload_builder['dumbbell_values'] >
		,
		ReturnType< $gymload_builder_day_results['dumbbell_values'] >
	>
	type $gymload_builder_day_results__weight_plate_values_gymload_builder_26 = $mol_type_enforce<
		ReturnType< $gymload_builder['weight_plate_values'] >
		,
		ReturnType< $gymload_builder_day_results['weight_plate_values'] >
	>
	type $gymload_builder_day_results__barbell_values_gymload_builder_27 = $mol_type_enforce<
		ReturnType< $gymload_builder['barbell_values'] >
		,
		ReturnType< $gymload_builder_day_results['barbell_values'] >
	>
	type $mol_view__title_gymload_builder_28 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['title'] >
	>
	type $mol_view__sub_gymload_builder_29 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $gymload_builder extends $mol_page {
		...
		dumbbell_values( ): ReturnType< ReturnType< $gymload_builder['DumbbellWeighs'] >['values'] >
		DumbbellWeighs( ): $gymload_builder_weights
		barbell_values( ): ReturnType< ReturnType< $gymload_builder['BarbellWeights'] >['values'] >
		BarbellWeights( ): $gymload_builder_weights
		weight_plate_values( ): ReturnType< ReturnType< $gymload_builder['WeightPlates'] >['values'] >
		WeightPlates( ): $gymload_builder_weights
		week_items( ): readonly($mol_view)[]
		Weeks( ): $mol_deck
		...
		title( ): string
		storage_key( ): string
		DaySettings( id: any): $gymload_builder_day
		DayResults( id: any): $gymload_builder_day_results
		Settings( ): $mol_view
		body( ): readonly(any)[]
	}
...
declare namespace $.$$ {
    class $gymload_builder extends $.$gymload_builder {
        week_items(): $.$gymload_builder_day[];
        day_title(id: any): string;
...
declare namespace $ {
	...
	export class $gymload extends $gymload_builder {
	}
