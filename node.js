...
;
	($.$gymload_smallnumber) = class $gymload_smallnumber extends ($.$mol_number) {};
...
var $;
(function ($) {
    $mol_style_attach("gymload/smallnumber/smallnumber.view.css", "[gymload_smallnumber_string] {\n\twidth: 4.5rem;\n}");
})($ || ($ = {}));
...
;
	($.$gymload_builder_weights) = class $gymload_builder_weights extends ($.$mol_view) {
		row_title(id){
			return "";
		}
		row_value(id, next){
		...
		Value(id){
			const obj = new this.$.$gymload_smallnumber();
			(obj.precision) = () => (0.1);
	...
	($mol_mem_key(($.$gymload_builder_weights.prototype), "row_value"));
	($mol_mem_key(($.$gymload_builder_weights.prototype), "Value"));
	($mol_mem_key(($.$gymload_builder_weights.prototype), "Labeler"));
	($mol_mem_key(($.$gymload_builder_weights.prototype), "row_remove"));
	($mol_mem_key(($.$gymload_builder_weights.prototype), "RemoveButton"));
	($mol_mem(($.$gymload_builder_weights.prototype), "add"));
	($mol_mem(($.$gymload_builder_weights.prototype), "enabled"));
	($mol_mem(($.$gymload_builder_weights.prototype), "Enabled"));
	($mol_mem(($.$gymload_builder_weights.prototype), "Items"));
	($mol_mem_key(($.$gymload_builder_weights.prototype), "Item"));
	($mol_mem(($.$gymload_builder_weights.prototype), "AddButton"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $gymload_builder_weights extends $.$gymload_builder_weights {
            build_key(s) {
        ...
        __decorate([
            $mol_mem
        ], $gymload_builder_weights.prototype, "values", null);
        __decorate([
            $mol_mem
        ], $gymload_builder_weights.prototype, "new_id", null);
        $$.$gymload_builder_weights = $gymload_builder_weights;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        const { rem } = $mol_style_unit;
        $mol_style_define($gymload_builder_weights, {
...
;
	($.$gymload_builder_day) = class $gymload_builder_day extends ($.$mol_view) {
		...
		WeightType_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_day_WeightType_labeler_title")));
		...
		Sets_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_day_Sets_labeler_title")));
		...
		Reps_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_day_Reps_labeler_title")));
		...
		BeginWeight_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_day_BeginWeight_labeler_title")));
		...
		FinishWeight_labeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_day_FinishWeight_labeler_title")));
		...
		Row(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.ChartWrapper(id)), (this.InputRow(id))]);
			return obj;
		}
		rows(){
			return [(this.Row("0"))];
		...
		AddButton(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_day_AddButton_title")));
		...
		MinStepLabeler(id){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_day_MinStepLabeler_title")));
	...
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_min_step"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "MinStep"));
	($mol_mem(($.$gymload_builder_day.prototype), "DayTitle"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Plan"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Vert_ruler"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Marker_hor"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Chart"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "ChartWrapper"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_exercise"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Exercise"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Exercise_labeler"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_weight_type"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "WeightType"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "WeightType_labeler"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_sets"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Sets"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Sets_labeler"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_reps"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Reps"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Reps_labeler"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_begin_weight"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "BeginWeight"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "BeginWeight_labeler"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_finish_weight"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "FinishWeight"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "FinishWeight_labeler"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "row_remove"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "RemoveButton"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "InputRow"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "Row"));
	($mol_mem(($.$gymload_builder_day.prototype), "Rows"));
	($mol_mem(($.$gymload_builder_day.prototype), "add_exercise"));
	($mol_mem(($.$gymload_builder_day.prototype), "AddButton"));
	($mol_mem_key(($.$gymload_builder_day.prototype), "MinStepLabeler"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $gymload_builder_day extends $.$gymload_builder_day {
            build_key(s) {
        ...
        __decorate([
            $mol_mem_key
        ], $gymload_builder_day.prototype, "plan", null);
        __decorate([
            $mol_mem
        ], $gymload_builder_day.prototype, "new_id", null);
        $$.$gymload_builder_day = $gymload_builder_day;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$gymload_builder_day_results_set) = class $gymload_builder_day_results_set extends ($.$mol_view) {
		past_week_results(){
			return "";
		}
		week_plan_weight(){
		...
		DoneWeekView(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.done_plan_label()), (this.DoneButton())]);
			return obj;
		}
		FutureWeekView(){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "week_weight"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "CurrentWeekWeight"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "CurrentWeekWeight_labeler"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "week_reps"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "CurrentWeekReps"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "CurrentWeekReps_labeler"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "done_week_click"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "DoneButton"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "Label"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "PastWeekView"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "CurrentWeekView"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "DoneWeekView"));
	($mol_mem(($.$gymload_builder_day_results_set.prototype), "FutureWeekView"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$gymload_builder_day_results_set = $gymload_builder_day_results_set;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($gymload_builder_day_results_set, {
            PastWeekView: {
                padding: $mol_gap.text,
            },
            FutureWeekView: {
...
;
	($.$gymload_builder_day_results) = class $gymload_builder_day_results extends ($.$gymload_builder_day) {
		set_idx(id){
			return 0;
		}
		current_week_number(){
		...
		Row(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.row_exercise(id)), (this.SetRows(id))]);
			return obj;
		}
		rows(){
			return [(this.Row("0"))];
		...
		SetResult(id){
			const obj = new this.$.$gymload_builder_day_results_set();
		...
		WeekTab(id){
			...
			(obj.sub) = () => ([(this.week_tab_title(id))]);
			return obj;
		}
		sub(){
			return [
	...
	($mol_mem_key(($.$gymload_builder_day_results.prototype), "row_sets"));
	($mol_mem(($.$gymload_builder_day_results.prototype), "DayTitle"));
	($mol_mem(($.$gymload_builder_day_results.prototype), "Weeks"));
	($mol_mem_key(($.$gymload_builder_day_results.prototype), "SetRows"));
	($mol_mem_key(($.$gymload_builder_day_results.prototype), "Row"));
	($mol_mem(($.$gymload_builder_day_results.prototype), "Rows"));
	($mol_mem_key(($.$gymload_builder_day_results.prototype), "SetResult"));
	($mol_mem_key(($.$gymload_builder_day_results.prototype), "WeekTab"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$gymload_builder_day_results = $gymload_builder_day_results;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$gymload_builder) = class $gymload_builder extends ($.$mol_page) {
		List_of_languages(){
		...
		Source_link(){
			...
			(obj.uri) = () => ("https://github.com/gymload/gymload.github.io");
			return obj;
		}
		Lighter(){
		...
		WeekCount_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_WeekCount_labeler_title")));
		...
		DayCount_labeler(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_DayCount_labeler_title")));
		...
		DumbbellWeighs(){
			const obj = new this.$.$gymload_builder_weights();
		...
		DaySettings(id){
			const obj = new this.$.$gymload_builder_day();
		...
		DayResults(id){
			const obj = new this.$.$gymload_builder_day_results();
			(obj.storage_key) = () => ((this.day_storage_key(id)));
			(obj.title) = () => ((this.day_title(id)));
			(obj.day_index) = () => ((this.day_index(id)));
			(obj.week_count) = () => ((this.week_count()));
		...
		Settings(){
			const obj = new this.$.$mol_view();
			(obj.title) = () => ((this.$.$mol_locale.text("$gymload_builder_Settings_title")));
			(obj.sub) = () => ([
	...
	($mol_mem(($.$gymload_builder.prototype), "List_of_languages"));
	($mol_mem(($.$gymload_builder.prototype), "Source_link"));
	($mol_mem(($.$gymload_builder.prototype), "Lighter"));
	($mol_mem(($.$gymload_builder.prototype), "week_count"));
	($mol_mem(($.$gymload_builder.prototype), "WeekCount"));
	($mol_mem(($.$gymload_builder.prototype), "WeekCount_labeler"));
	($mol_mem(($.$gymload_builder.prototype), "day_count"));
	($mol_mem(($.$gymload_builder.prototype), "DayCount"));
	($mol_mem(($.$gymload_builder.prototype), "DayCount_labeler"));
	($mol_mem(($.$gymload_builder.prototype), "DumbbellWeighs"));
	($mol_mem(($.$gymload_builder.prototype), "BarbellWeights"));
	($mol_mem(($.$gymload_builder.prototype), "WeightPlates"));
	($mol_mem(($.$gymload_builder.prototype), "Weeks"));
	($mol_mem(($.$gymload_builder.prototype), "TopDesk"));
	($mol_mem_key(($.$gymload_builder.prototype), "DaySettings"));
	($mol_mem_key(($.$gymload_builder.prototype), "DayResults"));
	($mol_mem(($.$gymload_builder.prototype), "Settings"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$gymload_builder = $gymload_builder;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$gymload) = class $gymload extends ($.$gymload_builder) {
		Theme(){
	...
	($mol_mem(($.$gymload.prototype), "Theme"));
